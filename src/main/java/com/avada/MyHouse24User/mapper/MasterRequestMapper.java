...
public class MasterRequestMapper {
    ...
    public MasterRequestDTO toDto(MasterRequest masterRequest){
        ...
        if(masterRequest.getRole()!=null)masterRequestDTO.setRole(Roles.getNameByRole(masterRequest.getRole().getName()));
        else masterRequestDTO.setRole(Roles.AnySpecialist.getName());
    ...
    public MasterRequest toEntity(MasterRequestDTO masterRequestDTO){
        ...
        if(Roles.getRoleByName(masterRequestDTO.getRole()) != null)masterRequest.setRole(rolesService.getByName(Roles.getRoleByName(masterRequestDTO.getRole())));
        ...
        masterRequest.setStatus(MasterRequestStatus.NEW.getName());
